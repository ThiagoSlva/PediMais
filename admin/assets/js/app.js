(function ($) {
  ...
  */
  ...
  /**
  * Utility function to update the button icons (sun/moon).
  */
  function updateButton({ buttonEl, isDark }) {
    ...
    buttonEl.setAttribute("aria-label", isDark ? "dark" : "light");
  }
  ...
  */
  ...
  /**
  * 3. If the button exists, update the theme setting and button icons according to current settings.
  */
  if (button) {
